...
/// Nodes are ASTContext-allocated and form a singly-linked list on FunctionDecl.
///
/// \code
...
/// \endcode
template <bool IsPostCondition>
class ContractAnnotationBase {
  Expr *Predicate;
...
/// \endcode
template <>
class ContractAnnotationBase<true> {
  Expr *Predicate;
  ContractAnnotationBase *Next = nullptr;
  SourceLocation KwLoc;
  SourceLocation LParenLoc, RParenLoc;
